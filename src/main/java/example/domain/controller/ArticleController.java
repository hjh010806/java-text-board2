...
import example.domain.model.ArticleMySQLRepository;
...
public class ArticleController {   // Model + Controller
    ...
    ArticleMySQLRepository articleMySQLRepository = new ArticleMySQLRepository();
    ...
    public void search() {
        ...
        ArrayList<Article> searchedList = articleMySQLRepository.findArticleByKeyword(keyword);
    ...
    public void detail() {
        ...
        Article article = articleMySQLRepository.findArticleById(inputId);
...
//        detailMenu(inputId);
    ...
    public void delete() {
        ...
        articleMySQLRepository.deleteArticle(article);
    ...
    public void update() {
        ...
        articleMySQLRepository.updateArticle(article, newTitle, newBody);
        System.out.printf("%d번 게시물이 수정되었습니다.\n", inputId);
    }

    public void list() {
        ArrayList<Article> articleList = articleMySQLRepository.findAll();
    ...
    public void add() {
        ...
        articleMySQLRepository.saveArticle(title, body);
...
//                articleFileRepository.saveComment(articleId, newComment); // 현재 상세보기 중인 게시물의 번호를 전달
//                break;
//            // 다른 기능들의 처리
//        }
